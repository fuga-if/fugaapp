...
export default function GachaHome(): React.ReactElement {
  const router = useRouter();
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-4 py-8">
      <div className="text-center animate-fade-in w-full max-w-sm">
        <div className="mb-6 animate-float"><Image src="/images/gacha/main-visual.png" alt="課金スタイル診断" width={280} height={280} className="mx-auto drop-shadow-[0_0_30px_rgba(255,215,0,0.3)]" priority /></div>
