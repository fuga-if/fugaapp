      ...
      <div className="text-center animate-fade-in w-full max-w-sm">
        ...
        <div className="pt-4">
          ...
          <div className="flex flex-col gap-2">
            <Link href="/rpg-job" className="text-amber-300/60 hover:text-amber-300 text-sm transition-colors"> 人生RPGジョブ診断 →</Link>
            <Link href="/yami-zokusei" className="text-amber-300/60 hover:text-amber-300 text-sm transition-colors"> 闇属性診断 →</Link>
